...
class CanvasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create canva" do
    assert_difference("Canva.count") do
      post canvas_url, params: { canva: { integer: @canva.integer, price: @canva.price, title: @canva.title } }, as: :json
    end
  ...
  test "should update canva" do
    patch canva_url(@canva), params: { canva: { integer: @canva.integer, price: @canva.price, title: @canva.title } }, as: :json
    assert_response :success
  end
